    ...
    if($image_tmp!="")
    {
        ...
        if($image_access==true)
        {
            ...
            if($edit>0)
            {
                ...
                @unlink("../images/pevents/".$old_image_name['image_name']);
            }

            move_uploaded_file($image_tmp,'../images/pevents/'.$image_upload_name);

            compress('../images/pevents/'.$image_upload_name, '../images/pevents/'.$image_upload_name, 80);
...
elseif($delete_img>0 && mysqli_num_rows(mysqli_query($db,"select id from $do where auto_id='$delete_img' and image_name!='' "))>0)
{
    ...
    @unlink('../images/pevents/'.$info_image_name['image_name']);
}
    ...
    <div class="content">
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($sql))
                {
                    ...
                    echo 'Title : <br />
                      ...
                      <br /><br />
                      Short text : <br />
                      <textarea name="short_text_'.$row["id"].'" cols="50" rows="5">'.$information["short_text"].'</textarea>
                      <br /><br />
                      Text : <br />
                ...
                {
                    $image='<ul class="media_photos" style="margin-left:450px;margin-top:-25px; margin-right: 40px;"><li><a rel="slide" href="../images/pevents/'.$information["image_name"].'?rand='.rand(0,10000).'" title="">
                    Current image : <img src="../images/pevents/'.$information ["image_name"].'?rand='.rand(0,10000).'" alt="" width="120" /></a>
                    <br class="clear" />
        ...
        while($row=mysqli_fetch_assoc($sql))
        {
            echo '<tr>
					...
					<td><ul class="media_photos" style="padding:0;margin-top:0px;margin-bottom:-40px"><li><a rel="slide" href="../images/pevents/'.$row["image_name"].'" title=""><img src="../images/pevents/'.$row["image_name"].'?rand='.rand(0,10000).'" width="100" height="60"></a></li></ul></td>
					<td>
