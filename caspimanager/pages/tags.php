...
{
    $query_count.=" and name like '%$tag_search%' ";
    $add_information_sql = " and name like '%$tag_search%'";
    $limit = 1000;
    ...
    <div class="content">
        ...
        <form action="index.php?do=<?php echo $do; ?>&page=<?php echo $page; ?><?php if($edit>0) echo '&edit='.$edit; ?>" method="post" id="form_login" name="form_login" enctype="multipart/form-data">
            ...
            while($row=mysqli_fetch_assoc($sql))
            {
                ...
                echo 'Name : <br />
                      <input type="text" name="name_'.$row["id"].'" value="'.$information["name"].'" style="width:250px" class="typeahead tm-input tm-input-info" />
                      <br /><br />
                      </div>
                      ';
            }
