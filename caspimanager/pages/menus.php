...
if($_POST) // Add && edit
{
    ...
    while($row=mysqli_fetch_assoc($sql))
    {
        ...
        {
            mysqli_query($db,"update $do set name='$name',link='$link',updated_at='$time' where lang_id='$row[id]' $add_where");
        }
        else
        {
            mysqli_query($db,"insert into $do values (0,'$name','$link','$last_order', '$active', '$row[id]', '$auto_id', '$time',0) ");
        }
    }
...
<div class="onecolumn">
    ...
    <div class="content">
        ...
        <form action="index.php?do=<?php echo $do; ?>&page=<?php echo $page; ?><?php if($edit>0) echo '&edit='.$edit; ?>" method="post" id="form_login" name="form_login" enctype="multipart/form-data">
            ...
            echo '<div class="'.$hide.'">';
            echo 'Link : <br />
                      <input type="text" name="link" value="'.$information["link"].'" style="width:350px" />
                      <br /><br />';
