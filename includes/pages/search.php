<div class="col-md-8 col-md-push-4 bwp-posts-col bwp-sidebar-left">
    <div class="bwp-posts-container" role="main">
        ...
        <div class="bwp-archive-heading">
            <h1 class="bwp-archive-title"><?=$lang1?>: '<?=$search?>'</h1>
        ...
        if($count_rows>0)
        {
            foreach ($result_news_by_search_arr as $item)
            {
            ...
            if($count_rows > $limit)
            {
                ...
                <nav class="navigation pagination" role="navigation">
                    ...
                    <div class="nav-links">
                        ...
                        {
                            ?>
                            <a class="first page-numbers" href="<?=SITE_PATH?>/search?search=<?=$search?>">
                                <i class="fa fa-step-backward"></i>
                            </a>
                            <a class="previous page-numbers" href="<?=SITE_PATH?>/search?search=<?=$search?>&page=<?=($page-1)?>">
                        ...
                        for ($i = $page - $show; $i <= $page + $show; $i++)
                        {
                            if ($i > 0 && $i <= $max_page)
                            {
                                ...
                                {
                                    ?>
                                    <a class='page-numbers' href='<?=SITE_PATH?>/search?search=<?=$search?>&page=<?=$i?>'><?=$i?></a>
                                    <?php
                                }
                            }
                        }
                        ...
                        {
                            ?>
                            <a class="next page-numbers" href="<?=SITE_PATH?>/search?search=<?=$search?>&page=<?=($page + 1)?>">
                                <i class="fa fa-caret-right"></i>
                            </a>
                            <a class="last page-numbers" href="<?=SITE_PATH?>/search?search=<?=$search?>&page=<?=$max_page?>">
        ...
        {
            ?>
            <div class="bwp-page-404-container" role="main">
                <h1><?=$lang16?></h1>
                <h2><?=$lang17?></h2>
                <p> - <?=$lang18?></p>
                <p> - <?=$lang19?></p>
