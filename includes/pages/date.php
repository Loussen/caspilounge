<div class="col-md-8 col-md-push-4 bwp-posts-col bwp-sidebar-left">
    <div class="bwp-posts-container" role="main">
        ...
        <div class="bwp-archive-heading">
            <h1 class="bwp-archive-title"><?=$lang22?>: <?=$month_str." ".$year?></h1>
            <div class="bwp-archive-heading-line"></div>
        </div>
        <!-- end archive heading -->

        <?php
            foreach ($news_by_date_arr as $item)
            {
                            ...
                            <ul class="bwp-post-meta list-unstyled">
                                <li>
                                        <span class="date updated">
                                            <i class="fa fa-clock-o"></i><a href="<?=SITE_PATH."/date/".date("Y",$item['created_at'])."/".date("m",$item['created_at'])?>"><?=$month_str." ".date("d",$item['created_at']).", ".date("Y",$item['created_at'])?></a>
                                        </span>
                                </li>
                            </ul>
                            <!-- end metadata -->
        ...
        if($count_rows > $limit)
        {
            ...
            <nav class="navigation pagination" role="navigation">
                ...
                <div class="nav-links">
                    ...
                    {
                        ?>
                        <a class="first page-numbers" href="<?=SITE_PATH?>/date/<?=$year.'/'.$month?>">
                            <i class="fa fa-step-backward"></i>
                        </a>
                        <a class="previous page-numbers" href="<?=SITE_PATH?>/date/<?=$year.'/'.$month.'/'.($page-1)?>">
                    ...
                    for ($i = $page - $show; $i <= $page + $show; $i++)
                    {
                        if ($i > 0 && $i <= $max_page)
                        {
                            ...
                            {
                                ?>
                                <a class='page-numbers' href='<?=SITE_PATH?>/date/<?=$year.'/'.$month.'/'.$i?>'><?=$i?></a>
                                <?php
                            }
                        }
                    }
                    ...
                    {
                        ?>
                        <a class="next page-numbers" href="<?=SITE_PATH?>/date/<?=$year.'/'.$month.'/'.($page + 1)?>">
                            <i class="fa fa-caret-right"></i>
                        </a>
                        <a class="last page-numbers" href="<?=SITE_PATH?>/date/<?=$year.'/'.$month.'/'.$max_page?>">
